<?php
    ...
    {
    $id=$_GET['del'];
    $sql = "DELETE from  leave_types  WHERE lt_id=?";
    $query = $conn->prepare($sql);
    $query -> bind_param('i',$id);
    $query -> execute();
    $msg="The selected leave type has been deleted";
...
<body>
	...
	<section id="content">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								...
								<section>
									<form action="new_leave.php" method="POST">
									<div class="row">
										<div class="col-md-12">
		...
		<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
			<div class="card-box pd-30 pt-10 height-100-p">
				    <h2 class="mb-30 h4">Leave List</h2>
				<div class="pb-20">
							...
							<div class="col-sm-12"><table class="data-table table stripe hover nowrap dataTable no-footer dtr-inline" id="DataTables_Table_0" role="grid">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input type="button" onClick="location.href='new_update_leavetype.php?upd=<?php echo $rows['lt_id'];?>'" , value='Update'/>
                                        <input type="button" onClick="location.href='new_leave.php?del=<?php echo $rows['lt_id'];?>'" , value='Delete'/>
                                    </td>                                             
                                        <?php
                                    $cnt++; }}
                                    ?>
