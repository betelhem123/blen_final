...
<div>
            ...
            <input type="text" name="departmentname"  class="form-control"id="departmentname" value="<?php echo $rows['departmentname'];?>" required>
        </div>
        <div>
            <label for="code">Code:</label>
            <input type="text" class="form-control" name="code" id="code" value="<?php echo $rows['departmentcode'];?>" required>
        </div>
