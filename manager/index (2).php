...
?>      
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					...
					$sql = "SELECT * from requested_leaves";
					$stmt = $conn -> query($sql);
					$rowCount = $stmt->num_rows;
				...
				BLEN Attendace Managment System developed by  Microlink Information Technology College <a href="http://localhost/projects/Blen_final/team.php" target="_blank"> Graduates of 2022 </a>
			</div>
