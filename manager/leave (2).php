				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							 <div class="dropdown">
  <button class="dropbtn">History Of Leaves</button>
	...
	<a href="accepted.php">Accepted</a>
		...
		<div class="card-box mb-30">
				<div class="pd-20">
						...
						<h2 class="text-blue h4">ALL REQUESTS</h2>
		  ...
		  <div class="col-3">
            <button type="submit" class="btn btn-primary btn-fill btn-block">Show</button>
				...
				<?php
                require_once '../includes/db.inc.php';
                $sql = "SELECT requested_leaves.leave_id as lid,employee.f_name,employee.l_name,employee.userID,employee.emp_id,requested_leaves.leavetype,requested_leaves.postingdate,requested_leaves.Status from requested_leaves join employee on requested_leaves.id_emp=employee.emp_id order by lid desc";
                $stmt = $conn->query($sql);
                echo ("");
